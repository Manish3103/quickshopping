...
if(isset($_POST['s']))
{
	...
	product_detailcheck()=='y')
	
	{	
		$pt=$_POST['pt'];
		$pid= $_GET['puid'];
		include"connection.php";
		 $query="update product set Product_type='".$pt."',Product_name='".$pn."',
		Quantity='".$q."',Price='".$p."',product_detail='".$pd."'
		where pid='".$pid."'";
...
<br><br>
Product-name:-<input type="text" name="pn" value="<?php echo $sq['Product_name']; ?>" readonly>
<span><?php echo $pnw; ?></span>
<br><br>
Quantity:-<input type="text" name="q"  value="<?php echo $sq['Quantity']; ?>">
<span><?php echo $qw; ?></span>
<br><br>
Price:-<input type="text" name="p"  value="<?php echo $sq['Price']; ?>">
<span><?php echo $pw; ?></span>
<br><br>
product_detail:-<input type="text" name="pd"  value="<?php echo $sq['product_detail']; ?>">
<span><?php echo $pdw; ?></span>
<br><br>
Photo:-<input type="file" name="ph"  value="<?php echo $sq['Photo']; ?>">
